...
All flashcards are stored as **CSV files** so they can be imported into tools like Anki, Quizlet, RemNote, etc.

Located in: `flashcards/`
...
- Core conjugations I actually use when speaking  
- Accuracy on irregular verbs  
- Building a foundation I can re-use in future decks (reflexives, preterite vs imperfect, etc.)
...
## 🌍 Why This Matters for My Portugal Plan

This repo is part of my broader **Portugal IT Career Transition**:

- Shows consistent, structured commitment to learning European Portuguese  
- Aligns with my goal of working in **IT Support in Portugal**  
- Provides evidence I can:
  - self-organise  
  - build systems for learning  
  - stick to long-term goals  

Together with my IT support labs and ticket simulations, this helps tell a clear story:

> “I’m not just moving to Portugal for the weather. I’m actively preparing for the language, culture, and workplace.”
